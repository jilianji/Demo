    ...
    public static BindType[] customTypeList =
    {
      ...
      //  _GT(typeof(Light)),
       ...
       // _GT(typeof(UIBehaviours)),
        ...
        _GT(typeof(SigninSq)),
        _GT(typeof(LoginSq)),
        _GT(typeof(ChooseRoleStr)),
        _GT(typeof(SourcesLoadSq)),
        _GT(typeof(UnityEngine.TextAsset)),
        _GT(typeof(ObjectsInfo)),
        _GT(typeof(ShopWeapon)),
        _GT(typeof(ShopWeaponItem)),
        _GT(typeof(SkillsInfo)),
