...
public class SkillsInfoWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(SkillsInfo), typeof(UnityEngine.MonoBehaviour));
		L.RegFunction("GetSkillInfoById", GetSkillInfoById);
		L.RegFunction("ReadSkillInfo", ReadSkillInfo);
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.Push(L, SkillsInfo.Instance);
			return 1;
		}
		catch(Exception e)
		{
